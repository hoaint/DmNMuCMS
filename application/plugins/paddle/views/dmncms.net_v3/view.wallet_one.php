                                ...
                                <?php
                                    if(isset($error)){
										...
										<li>
											...
											<button class="right custom_button" id="buy_walletone_' . $packages['id'] . '" style="margin-top: 8px;" value="buy_paypal_' . $packages['id'] . '">' . _('Buy Now') . '</button>
										</li>
								</ul>';
                                            }
                                        }
                                        else{
                                            echo '<div class="i_note">' . _('No WaletOne Packages Found.') . '</div>';
                                        }
                                    }
                                ?>
                            </div>
