...
?>
    <div id="content" class="span10">
        <div>
            <ul class="breadcrumb">
                <li><a href="<?php echo $this->config->base_url; ?>paddle/admin">Paddle Settings</a> <span
                        class="divider">/</span></li>
                <li><a href="<?php echo $this->config->base_url; ?>paddle/logs">Paddle Transactions</a>
                </li>
            </ul>
        </div>
        <?php
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-append">
                                    ...
                                    <button class="btn" type="submit" name="search_paddle_transactions" value="1">
                                        Search
                                    </button>
                                </div>
                            </div>
