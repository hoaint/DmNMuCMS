...
<div id="content" class="span10">
    <div>
        <ul class="breadcrumb">
            <li><a href="<?php echo $this->config->base_url; ?>payu/admin">PayU Settings</a> <span class="divider">/</span></li>
            <li><a href="<?php echo $this->config->base_url; ?>payu/logs">PayU Transactions</a>
            </li>
        </ul>
    </div>
    <?php
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="input-append">
                                ...
                                <button class="btn" type="submit" name="search_payu_transactions" value="1">Search</button>
                            </div>
                        </div>
                    </div>
                </form>
